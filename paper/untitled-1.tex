...
Quando o robô atinge o objetivo final deve sinalizar que lá chegou, através dos leds que possui. 

\subsection{Botões de Comando}
Os botões de comando, Start e Stop, permitem ao simulador controlar o decorrer da competição, devendo o robô obedecer à sua mudança.
